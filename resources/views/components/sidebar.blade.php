<div class="sidebar shadow" id="adminSidebar">
    ...
    <nav class="nav flex-column gap-1"> {{-- Tambahkan sedikit gap antar menu --}}
        ...
        {{-- PERBAIKAN: href="dashboard" menjadi href="/admin/dashboard" --}}
        <x-nav-link href="/admin/dashboard" :active="request()->is('admin/dashboard')" icon="bi-speedometer2">Dashboard</x-nav-link>
        ...
        {{-- PERBAIKAN: href="laporan" menjadi href="/admin/laporan" --}}
        <x-nav-link href="/admin/laporan" :active="request()->is('admin/laporan')" icon="bi-exclamation-octagon-fill">Laporan Warga</x-nav-link>
