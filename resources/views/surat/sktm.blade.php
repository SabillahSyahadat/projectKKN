...
<head>
    <meta charset="utf-8">
    <title>SKTM - {{ $warga->nama_warga }}</title>
    <style>
        /* Pengaturan Kertas */
        @page { margin: 1cm 2cm; }
...
<body>
    ...
    <div class="judul-container">
        ...
        <div class="nomor-surat">Nomor: 400 / {{ $surat->id ?? '...' }} / 413.312.05 / 2026</div>
    </div>
    ...
    <div class="isi-surat">
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td class="titik-dua">:</td>
                <td>{{ $warga->alamat }}, {{ \Carbon\Carbon::parse($warga->tanggal_lahir)->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
        ...
        <p class="paragraf">
            Bahwa nama tersebut di atas adalah benar-benar warga Desa Sidomulyo yang tergolong dalam keluarga ekonomi lemah / <strong>Tidak Mampu</strong>. 
        </p>
        
        <p class="paragraf">
            Surat keterangan ini diberikan kepada yang bersangkutan untuk dipergunakan sebagai persyaratan: <br>
            <center><strong>" {{ strtoupper($surat->keterangan ?? 'KEPERLUAN ADMINISTRASI') }} "</strong></center>
        </p>
        
        <p class="paragraf">
            Demikian surat keterangan ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya dan bagi instansi yang berkepentingan agar menjadi maklum.
        </p>
    </div>
