...
@section('title', 'Layanan Surat Digital - Desa Sidomulyo')

@section('custom-css')
<style>
  /* Menimpa variabel warna dari layout utama khusus untuk halaman ini (Tema Merah) */
  :root {
