...
|--------------------------------------------------------------------------
| Route yang bisa diakses siapa saja tanpa harus login.
*/

// Halaman utama warga (index)
...
/*
|--------------------------------------------------------------------------
| Route Warga (Harus Login sebagai Warga)
|--------------------------------------------------------------------------
| Semua route di bawah ini membutuhkan login via guard 'warga'.
| Jika belum login, akan di-redirect ke /auth/login.
*/
...
Route::middleware('auth.warga')->group(function () {
    ...
    Route::get('/auth/logout', [AuthController::class, 'logout'])->name('logout.auth');
...
|--------------------------------------------------------------------------
| Semua route di bawah ini membutuhkan login via guard 'admin'.
| Jika belum login, akan di-redirect ke /auth/loginAdmin.
*/
